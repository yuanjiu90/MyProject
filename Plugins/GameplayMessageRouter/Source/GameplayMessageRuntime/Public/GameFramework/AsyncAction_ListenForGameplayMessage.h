...
public:
	...
	// 一定要 Unregister 或者 Cancel
	UFUNCTION(BlueprintCallable, Category = Messaging, meta = (WorldContext = "WorldContextObject", BlueprintInternalUseOnly = "true"))
	static UAsyncAction_ListenForGameplayMessage* ListenForSimpleGameplayMessages(UObject* WorldContextObject, FGameplayTag Channel, EGameplayMessageMatch MatchType = EGameplayMessageMatch::ExactMatch);

	// 勿要改名（蓝图自定义节点和名字有关）
	// 一定要 Unregister 或者 Cancel
	UFUNCTION(BlueprintCallable, Category = Messaging, meta = (WorldContext = "WorldContextObject", BlueprintInternalUseOnly = "true"))
	static UAsyncAction_ListenForGameplayMessage* ListenForGameplayMessagesWithNoPayload(UObject* WorldContextObject, FGameplayTag Channel, EGameplayMessageMatch MatchType = EGameplayMessageMatch::ExactMatch);
	/**
