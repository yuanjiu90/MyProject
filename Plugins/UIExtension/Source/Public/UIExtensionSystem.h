...
public:
	...
	void Reset() { DataPtr.Reset(); ExtensionSource.Reset(); }
	...
	void SetWidget(UUserWidget* Widget) const
	{
		if (IsValid())
		{
			DataPtr->Widget = Widget;
		}
	}
...
// class UIEXTENSION_API UUIExtensionSubsystem : public UGameInstanceSubsystem
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, BlueprintCosmetic, Category = "UI Extension")
	static void Reset(UPARAM(ref) FUIExtensionHandle& Handle);
