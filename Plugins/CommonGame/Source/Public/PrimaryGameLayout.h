...
protected:
	...
	void OnDisplayedWidgetChanged(UCommonActivatableWidget* DisplayedWidget);
...
private:
	...
	DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FDSOnDisplayedWidgetChanged, UCommonActivatableWidget*, DisplayedWidget);
	UPROPERTY(BlueprintAssignable, Category="Layer")
	FDSOnDisplayedWidgetChanged OnDisplayedWidgetChangedEvent;
};
